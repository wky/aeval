...
time build/tools/bv/bv --chc-file="bench_horn_bv/aes-3.smt2" --const-bw=4 --ante-size=1 --conseq-size=2 --conseq-disj=1 --grammar-file="bench_horn_bv/aes.gmr" > logs/aes-3.log
time build/tools/bv/bv --chc-file="bench_horn_bv/aes-4.smt2" --const-bw=4 --ante-size=1 --conseq-size=2 --conseq-disj=1 --grammar-file="bench_horn_bv/aes.gmr" > logs/aes-4.log

#fail
time build/tools/bv/bv --chc-file="bench_horn_bv/aes-5.smt2" --const-bw=4 --ante-size=1 --conseq-size=2 --conseq-disj=1 --grammar-file="bench_horn_bv/aes.gmr" > logs/aes-5.log
